package com.santander.msanalysisservices.controller.exception;

import com.fasterxml.jackson.annotation.JsonInclude;
import com.santander.msanalysisservices.constants.AnalysisConstants;
import com.santander.msanalysisservices.exception.AlreadyExistsException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handlerUserIllegalArgumentException(BusinessException ex) {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        Problem problem = getProblem(
                ...
                AnalysisConstants.ARGUMENT_INVALID,
                camposDeErros);
